...
public class TransactionTest {
    private static LocalDateTime releaseDate = new LocalDateTime().minusDays(45);
    private static final Movie FINDING_NEMO = new Movie("Finding Nemo", releaseDate);
    private static final Movie SHAWSHANK_REDEMPTION = new Movie("Shawshank Redemption", releaseDate);
